  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className={cn(
          "relative inline-flex items-center justify-center w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-full border-4 mb-4",
          config.bgClass,
          config.borderClass,
      ...
      >
        ...
        <div className="flex flex-col items-center">
          <span className={cn("text-4xl sm:text-5xl font-bold", config.textClass)}>
            {result.grade}
          </span>
      ...
      <motion.h2
        ...
        className="font-heading text-xl sm:text-2xl md:text-3xl font-bold text-foreground mb-3"
      >
        {result.title}
      </motion.h2>
      ...
      <motion.p
        ...
        className="text-muted-foreground text-sm sm:text-base md:text-lg leading-relaxed mb-4"
      >
        {result.message}
      </motion.p>
