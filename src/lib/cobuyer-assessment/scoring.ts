 ...
 *
 * Dimension-weighted scoring across 5 assessment areas.
 * Trimmed from 7→5 dimensions to match 15-question format (issue #347).
 */
...
const DIMENSIONS: DimensionDef[] = [
  {
    ...
    weight: 0.15,
    questionKeys: ["relationship_type", "relationship_duration"],
    maxPoints: 6,
  },
  {
    name: "Financial Compatibility",
    weight: 0.25,
    questionKeys: ["financial_awareness", "money_personality", "financial_transparency"],
    maxPoints: 9,
  },
  {
    name: "Lifestyle Alignment",
    weight: 0.15,
    questionKeys: ["lifestyle_dependents", "lifestyle_alignment", "work_situation"],
    maxPoints: 7,
  },
  {
    name: "Goals & Expectations",
    weight: 0.25,
    questionKeys: ["timeline_alignment", "ownership_duration", "property_vision"],
    maxPoints: 9,
  },
  {
    name: "Trust & Communication",
    weight: 0.20,
    questionKeys: ["conflict_style", "trust_score", "agreement_willingness"],
    maxPoints: 9,
  },
]
